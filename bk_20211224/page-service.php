		...
		<div class="l-home_hero">
			<div class="slick js-animateblock">
				<div class="slick__list">
					...
					<div class="slick__item"><a href="<?php echo home_url('/service/information-service/★新しい決済サービスのご案内★/'); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/slider_02.png" alt="" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/home/slider_02.png 1x, <?php echo get_template_directory_uri(); ?>/assets/img/home/slider_02_sp.png 768w"></a></div>
					...
					<!--div class="slick__item"><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/home/slider_03.png" alt="" srcset="<?php echo get_template_directory_uri(); ?>/assets/img/home/slider_03.png 1x, <?php echo get_template_directory_uri(); ?>/assets/img/home/slider_03_sp.png 768w"></a></div-->
				</div>
			</div>
		</div>
			...
			<div class="l-home_section__inner p-home_extra__inner">
				<div class="p-home_extra__body">
					<ul class="p-home_extra__list">
						...
						<li class="p-home_extra__item useful">
							<a href="<?php echo home_url('/service/privilege/'); ?>" class="">
								<figure>
									<img src="<?php echo get_template_directory_uri(); ?>/assets/img/common/banner_02.jpg" alt="">
									<figcaption class="title p-icon--useful">お役立ち情報</figcaption>
								</figure>
							</a>
						</li>
