			...
			<section class="l-page_section pb0">
				<div class="p-page_survey">
					...
					<div class="p-page_survey__body bg--gray">
						<ul class="p-radio">
							<li class="p-radio--karitai"><a href="<?php echo home_url('/service/survey/rental-survey/'); ?>" class="<?php if(is_page('rental-survey')){print 'selected';} ?>">賃貸物件</a></li>
							<li class="p-radio--kaitai"><a href="<?php echo home_url('/service/survey/purchase-survey/'); ?>" class="<?php if(is_page('purchase-survey')){print 'selected';} ?>">物件購入</a></li>
							<li class="p-radio--uritai"><a href="<?php echo home_url('/service/survey/sale-survey/'); ?>" class="<?php if(is_page('sale-survey')){print 'selected';} ?>">物件売却</a></li>
