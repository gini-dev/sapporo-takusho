						...
						<div class="p-page_sub_section__inner">
							<div class="p-page_sub_section__head">
								<div class="p-page_sub_section__title js-animateblock--reveal">
									<div class="elem_en kaitai">SUPPORT</div>
									<div class="elem_jp kaitai">
										<span><b>一生で一番の</b></span><br>
										<span><b>お買い物のお手伝い</b></span>
									</div>
								</div>
							</div>
								...
								<div class="p-module_message__column">
									<div class="p-module_message__column__inner">
										<div class="p-module_message__column__content">
											...
											<p>物件購入後、引っ越しをしてそこに住むのですが、通勤や通学、毎日のお買い物などの交通の利便性の他、その地域の特徴や治安などを加味した上で、後々後悔することがないように慎重に決定する必要があります。</p>
										</div>
										<div class="p-module_message__column__image">
								...
								<div class="p-module_message__column">
									<div class="p-module_message__column__inner">
										<div class="p-module_message__column__content">
											...
											<h3 class="p-heading_lv3 kaitai">一戸建てと、マンション<br>
												新築と中古について</h3>
				...
				<div class="c-module_point">
					<div class="c-module_point__head">
						<div class="p-page_sub_section__title js-animateblock--reveal">
							...
							<div class="elem_jp kaitai">
								<span><b>札幌宅商から購入する7つのメリット</b></span>
							</div>
						</div>
					</div>
						...
						<div class="c-module_point__wrap">
							...
							<div class="c-module_point__inner js-animateblock">
								...
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										...
										<div class="c-module_point__column__image">
											<img src="<?php echo get_template_directory_uri(); ?>/assets/img/kaitai/image_merit_02.jpg" alt="">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										<div class="c-module_point__column__content">
											...
											<p>物件のお引き渡し後、定期的にご自宅に訪問し、軽微な不具合・故障は即対応。そして各業者様への手配、その他工事のご提案をさせていただきます。</p>
										</div>
										<div class="c-module_point__column__image">
							...
							<div class="c-module_point__inner js-animateblock">
								...
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										<div class="c-module_point__column__content">
											<h3 class="p-heading_lv3 kaitai">物件リクエスト</h3>
											<h4 class="p-heading_lv4">希望の物件条件を簡単リクエスト</h4>
											<p>当ホームページの「物件リクエスト」ページから、お客様のご希望をご記入ください。弊社でご希望と合致する物件をお調べし、ご案内いたします。</p>
										</div>
										<div class="c-module_point__column__image">
							...
							<div class="c-module_point__inner js-animateblock">
								<div class="c-module_point__icon kaitai"><div class="c-module_point__icon__inner">Merit<b>05</b></div></div>
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										<div class="c-module_point__column__content">
											<h3 class="p-heading_lv3 kaitai">建物状況調査</h3>
											<h4 class="p-heading_lv4">SSS（Sapporo Takusho Safety Support）</h4>
											<p>売主様がご自宅のインスペクション（建物状況調査）をプロの検査期間に依頼する際、その調査費用を弊社が負担させていただきます。<br>
											※引受には当社規定の条件がございます。</p>
										</div>
										<div class="c-module_point__column__image">
							...
							<div class="c-module_point__inner js-animateblock">
								<div class="c-module_point__icon kaitai"><div class="c-module_point__icon__inner">Merit<b>06</b></div></div>
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										<div class="c-module_point__column__content">
											...
											<ul class="point kaitai">
												...
												<li>
													<dl>
														<dt>オンライン内見</dt>
														<dd>Google Duo、Facetime、LINE通話での利用となります。</dd>
													</dl>
												</li>
												<li>
													<dl>
							...
							<div class="c-module_point__inner js-animateblock">
								<div class="c-module_point__icon kaitai"><div class="c-module_point__icon__inner">Merit<b>07</b></div></div>
								<div class="c-module_point__column">
									<div class="c-module_point__column__inner">
										<div class="c-module_point__column__content">
