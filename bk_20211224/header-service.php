...
<?php
	...
	}elseif(is_page('rental-survey') || is_page('purchase-survey') || is_page('sale-survey') || is_page('reform-survey')){
			...
			<div class="l-site_header__gnav__inner">
				...
				<aside>
					<ul>
						...
						<li><a href="<?php echo home_url('/service/investors/'); ?>">投資家の皆様へ</a></li>
