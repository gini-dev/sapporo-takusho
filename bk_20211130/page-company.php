...
?>
			...
			<a href="<?php echo home_url('/company/report/'); ?>" class="more-link">一覧を見る<span class="arrow-circle"></span></a>
		</div>
	</div><!-- /.top-news-area -->
</div><!-- /.top-mv -->
...
?>
					<li><a href="<?php print get_permalink( ); ?>">
						...
						<div class="txt">
							...
							<div class="sub"><?php print get_field('hire_date'); ?>年入社/<?php echo esc_html($placeterms[0]->name); ?>/<?php echo esc_html($clubterms[0]->name); ?></div>
						</div>
					</a></li>
<?php
	endwhile;endif;
