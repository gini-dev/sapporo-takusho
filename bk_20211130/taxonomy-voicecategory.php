				...
				<div class="l-page_section__inner">
					<section class="p-page_voice">
						<div class="p-page_voice__head">
							<ul class="navi">
								<li class="navi__item all"><a href="<?php echo home_url('/service/voice/'); ?>">すべて</a></li>
								<li class="navi__item karitai <?php if($termslug == 'karitai'){print 'current';} ?>"><a href="<?php echo home_url('/service/voicecategory/karitai/'); ?>">賃貸</a></li>
								<li class="navi__item kashitai <?php if($termslug == 'kashitai'){print 'current';} ?>"><a href="<?php echo home_url('/service/voicecategory/kashitai/'); ?>">賃貸管理</a></li>
								<li class="navi__item kaitai <?php if($termslug == 'kaitai'){print 'current';} ?>"><a href="<?php echo home_url('/service/voicecategory/kaitai/'); ?>">売買</a></li>
								<li class="navi__item uritai <?php if($termslug == 'uritai'){print 'current';} ?>"><a href="<?php echo home_url('/service/voicecategory/uritai/'); ?>">不動産売却</a></li>
								<li class="navi__item reform <?php if($termslug == 'reform'){print 'current';} ?>"><a href="<?php echo home_url('/service/voicecategory/reform/'); ?>">リフォーム</a></li>
							</ul>
						</div>
