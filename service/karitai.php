						...
						<div class="p-page_sub_section__inner">
							<div class="p-page_sub_section__head">
								<div class="p-page_sub_section__title js-animateblock--reveal">
									<div class="elem_en karitai">ABOUT</div>
				...
				<div class="p-page_choice__inner">
					<div class="p-page_choice__head js-animateblock">
						...
						<div class="p-page_choice__content js-animateblock">
							...
							札幌宅商の当たり前</h3>
							<p>
								物件を選ぶ前に不動産会社を選ぶことがとても大切になります。<br>
								弊社では物件の良し悪しについてもしっかり説明し、住んでからのギャップがないように心がけております。時には借りた方が良いのか、買った方が良いのか真剣に話し合うこともあります。お客様と一緒にお部屋探しをすることが札幌宅商のポリシーです。<br>
								お客様からご要望をしっかりとヒアリングし、ご希望に沿った物件へとスムーズにご案内しています。
							</p>
							<!--div class="p-btn--more karitai-link"><div class="inner"><span><a href="<?php echo home_url('/category/service/choice/'); ?>">不動産の選び方について<i class="p-icon--arrow_r_01"></i></a></span></div></div-->
						</div>
					</div>
